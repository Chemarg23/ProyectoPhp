...
<div id="searchForm" class="container mt-5">
    ...
    <form action="{{ route('update',['id' => request()->route('id')]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12 text-center mb-3">
                <h2>Modifique la tarea</h2>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ $task_info['nombre'] ?? filter_input(INPUT_POST, 'nombre') }}"
                        class="form-control">
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="apellido" id="apellido"
                        value="{{ $task_info['apellido'] ?? filter_input(INPUT_POST, 'apellido') }}" class="form-control">
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="dni" id="dni" value="{{$task_info['NIF'] ?? filter_input(INPUT_POST, 'dni') }}"
                        class="form-control">
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="tel" id="tel" value="{{$task_info['telefono'] ?? filter_input(INPUT_POST, 'tel') }}"
                        class="form-control">
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="mail" id="mail" value="{{$task_info['email'] ?? filter_input(INPUT_POST, 'mail') }}"
                        class="form-control">
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input type="date" name="fecha" id="fecha" value="{{ $task_info['fecha_realizacion'] ?? filter_input(INPUT_POST, 'fecha') }}"
                        class="form-control">
            ...
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="desc" id="desc" value="{{ $task_info['descripcion'] ?? filter_input(INPUT_POST, 'desc') }}"
                        class="form-control">
            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    ...
                    @php
                        echo CreaSelect('provincia', getProvincias(), $task_info['provincia'] ?? filter_input(INPUT_POST, 'provincia'), 'form-select');
                    @endphp
            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="poblacion" id="poblacion"
                        value="{{ $task_info['poblacion'] ?? filter_input(INPUT_POST, 'poblacion') }}" class="form-control">
            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="codigo-postal" id="codigo-postal"
                        value="{{ $task_info['codigo_postal'] ?? filter_input(INPUT_POST, 'codigo-postal') }}" class="form-control">
            ...
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="direccion" id="direccion"
                        value="{{ $task_info['direccion'] ?? filter_input(INPUT_POST, 'direccion') }}" class="form-control">
            ...
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    ...
                    @php
                        ...
                        echo CreaSelect('estado', $estados, $task_info['estado'] ?? filter_input(INPUT_POST, 'estado'), 'form-select');
                    @endphp
            ...
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    ...
                    @php
                        echo CreaSelect('operador', getOperators(), $task_info['op_id'] ?? filter_input(INPUT_POST, 'operador'), 'form-select');
                    @endphp
            ...
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="comentario" id="miTextarea" rows="3" cols="150">{{ $task_info['comentario'] ?? filter_input(INPUT_POST,'comentario') }}</textarea>
                </div>
            </div>

            <div class="col-md-12">
                <div class="mt-4 d-flex justify-content-center">
                    <button type="submit" class="btn btn-primary col-md-4" value="add">Actualizar</button>
                </div>
            </div>
        </div>
    </form>
