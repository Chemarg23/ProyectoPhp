@php
    if (file_exists('images\users/' . SessionManager::getUserId() . '.jpg')) {
        $img_path = 'images\users/' . SessionManager::getUserId() . '.jpg';
    } else {
        $img_path = "images\users/default.jpg";
    }
@endphp
<aside class="min-vh-100 col-md-2 text-white">
    <div class="p-3 bg-light" style="height: 100%;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="{{ route('inbox')."?op_id=".SessionManager::getUserId() }}" class="nav-link link-dark">
                    <svg class="bi me-2" width="16" height="16">
            ...
            <li class="nav-item dropdown mt-auto ">
                <a class="nav-link dropdown-toggle link-dark" href="#" id="navbarDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    <svg class="bi me-2" width="16" height="16">
        ...
        bottom: 0;">
            ...
            <div class="dropdown mt-auto">
                ...
                <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
                    <li><a class="dropdown-item" href="{{ route('changeProfile', ['id' => SessionManager::getUserId()]) }}">Editar Perfil</a></li>
        
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a class="dropdown-item" href="{{ route('logOut') }}">Sign out <i class="bi bi-box-arrow-right"></i></a></li>
